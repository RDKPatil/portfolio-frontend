        ...
        <form action="{{ route('posts.update', $post) }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="url" name="image" id="image" value="{{ old('image', $post->image) }}"
                    ...
                    @if($post->image)
                        <div class="mt-3">
                            ...
                            <img src="{{ $post->image }}" alt="Current cover"
                                class="h-24 w-auto rounded-lg shadow-sm border border-gray-200 object-cover">
                        </div>
                    @endif
                </div>
