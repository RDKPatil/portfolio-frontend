...
@section('content')
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 max-w-3xl">
        <form action="{{ route('about-sections.update', $aboutSection) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="space-y-4">
                <div>
                    ...
                    <select name="section_type" id="section_type"
                        ...
                        required>
                        <option value="experience" {{ $aboutSection->section_type == 'experience' ? 'selected' : '' }}>Work
                            Experience</option>
                        <option value="education" {{ $aboutSection->section_type == 'education' ? 'selected' : '' }}>Education
                        </option>
                        <option value="approach" {{ $aboutSection->section_type == 'approach' ? 'selected' : '' }}>Approach
                        </option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" value="{{ $aboutSection->title }}"
                        class="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 p-2 border"
                        required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="company" id="company" value="{{ $aboutSection->company }}"
                        class="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 p-2 border">
                </div>

                <div>
                    <label for="duration" class="block text-sm font-medium text-gray-700">Duration</label>
                    <input type="text" name="duration" id="duration" value="{{ $aboutSection->duration }}"
                        class="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 p-2 border">
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                        class="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 p-2 border"
                        required>{{ $aboutSection->description }}</textarea>
                </div>

                <div>
                    <label for="order" class="block text-sm font-medium text-gray-700">Display Order</label>
                    <input type="number" name="order" id="order" value="{{ $aboutSection->order }}"
                        class="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 p-2 border">
                </div>
            </div>
