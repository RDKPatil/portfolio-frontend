...
@section('content')
    <div class="mb-8 flex items-center justify-between">
        <h1 class="text-3xl font-bold text-gray-900">Add New Skill</h1>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="category" id="category"
                        class="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 p-2 border"
                        placeholder="e.g., Languages, Frameworks" required>
                </div>

                <div>
                    <label for="proficiency_level" class="block text-sm font-medium text-gray-700">Proficiency Level
                        (1-100)</label>
                    <input type="number" name="proficiency_level" id="proficiency_level" min="1" max="100" value="50"
                        class="mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-slate-500 focus:ring-slate-500 p-2 border">
                </div>
