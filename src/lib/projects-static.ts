// Static fallback data for when API is unavailable (e.g., Vercel build)
export const staticProjects = [
    {
        ...
        techStack: ["Laravel", "React", "MySQL", "REST APIs", "Shopify API"],
        featured: true,
    },
    {
        ...
        techStack: ["Laravel", "Power BI", "MySQL", "REST APIs", "ETL Pipelines"],
        featured: true,
    },
    {
        ...
        techStack: ["Node.js", "Three.js", "MongoDB", "Express", "HTML/CSS"],
        featured: false,
    },
];
